		...
		<div class="row-fluid">
			...
			<div class="hero-unit row">
				<div class="span7">
					...
					First we will construct a tree and to do that we have to start with
					the insertion method. <br>
					<h5>Step#1</h5>
					...
					</font> is <font color="#610B0B">null</font>, our first node is considered
					the <font color="#0000FF"> root </font> node.
